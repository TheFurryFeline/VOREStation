...
/mob/living/simple_mob/hostile/metroid
	name = "metroid"
...
/mob/living/simple_mob/hostile/metroid/init_vore() //graciously ~stolen~ inspired from the Synx code
	..()
...
/mob/living/simple_mob/hostile/metroid //activate noms
	vore_active = 1
	vore_pounce_chance = 25
	vore_icons = SA_ICON_LIVING
	isEdible = 0

/mob/living/simple_mob/hostile/metroid/death()
	playsound(src, 'sound/effects/metroiddeath.ogg', 50, 1)
	..()

/mob/living/simple_mob/hostile/metroid/pet //Security's pet
	name = "Jellybrig"
...
/mob/living/simple_mob/hostile/metroid/mine
	name = "Mochtroid"
	...
	vore_icons = SA_ICON_LIVING
/mob/living/simple_mob/hostile/metroid/mine/init_vore()
	..()
	var/obj/belly/B = vore_selected
	B.digest_burn = 1
	B.digest_brute = 0
...
/mob/living/simple_mob/hostile/metroid/mine/death()
	playsound(src, 'sound/effects/metroiddeath.ogg', 50, 1)
	..()
	if(prob(20))
...
/mob/living/simple_mob/hostile/metroid/evolution/baby
	name = "baby metroid"
	...
	evo_point = 800
	evo_limit = 1000
	next = "/mob/living/simple_mob/hostile/metroid/evolution/super"
	vore_active = 0

/mob/living/simple_mob/hostile/metroid/evolution/baby/New()
...
/mob/living/simple_mob/hostile/metroid/evolution/super
	name = "super metroid"
	...
	evo_point = 1200
	evo_limit = 1400
	next = "/mob/living/simple_mob/hostile/metroid/combat/alpha"
...
/mob/living/simple_mob/hostile/metroid/evolution/super/New()
	playsound(src, 'sound/metroid/metroidsee.ogg', 100, 1)
	..()

/mob/living/simple_mob/hostile/metroid/evolution/super/death()
...
/mob/living/simple_mob/hostile/metroid/combat/alpha
	name = "alpha metroid"
	...
	evo_point = 1200
	evo_limit = 1400
	next = "/mob/living/simple_mob/hostile/metroid/combat/gamma"

/mob/living/simple_mob/hostile/metroid/combat/alpha/New()
	playsound(src, 'sound/metroid/metroidsee.ogg', 100, 1)
	..()

/mob/living/simple_mob/hostile/metroid/combat/alpha/death()
	playsound(src, 'sound/metroid/metroiddeath.ogg', 100, 1)
	..()

/mob/living/simple_mob/hostile/metroid/combat/alpha //active noms
	vore_active = 1
	vore_bump_chance = 0
	vore_capacity = 1
	vore_icons = SA_ICON_LIVING
...
/mob/living/simple_mob/hostile/metroid/combat/gamma
	name = "gamma metroid"
	...
	evo_point = 1200
	evo_limit = 1400
	next = "/mob/living/simple_mob/hostile/metroid/combat/zeta"

/mob/living/simple_mob/hostile/metroid/combat/gamma/New()
	playsound(src, 'sound/metroid/metroidgamma.ogg', 100, 1)
	..()

/mob/living/simple_mob/hostile/metroid/combat/gamma/death()
	playsound(src, 'sound/metroid/metroiddeath.ogg', 100, 1)
	..()

/mob/living/simple_mob/hostile/metroid/combat/gamma //active noms
	vore_active = 1
	vore_bump_chance = 0
	vore_capacity = 1
	vore_icons = SA_ICON_LIVING
...
/mob/living/simple_mob/hostile/metroid/combat/zeta
	name = "zeta metroid"
	...
	evo_point = 1600
	evo_limit = 1800
	next = "/mob/living/simple_mob/hostile/metroid/combat/omega"

/mob/living/simple_mob/hostile/metroid/combat/zeta/New()
	playsound(src, 'sound/metroid/metroidzeta.ogg', 100, 1)
	..()

/mob/living/simple_mob/hostile/metroid/combat/zeta/death()
	playsound(src, 'sound/metroid/metroiddeath.ogg', 100, 1)
	..()

/mob/living/simple_mob/hostile/metroid/combat/zeta //active noms
	vore_active = 1
	vore_bump_chance = 0
	vore_capacity = 1
	vore_icons = SA_ICON_LIVING
...
/mob/living/simple_mob/hostile/metroid/combat/omega
	name = "omega metroid"
	...
	evo_point = 1700
	evo_limit = 2000
	next = "/mob/living/simple_mob/hostile/metroid/combat/queen"

/mob/living/simple_mob/hostile/metroid/combat/omega/New()
	playsound(src, 'sound/metroid/metroidomega.ogg', 100, 1)
	..()

/mob/living/simple_mob/hostile/metroid/combat/omega/death()
	playsound(src, 'sound/metroid/metroidomegadeath.ogg', 100, 1)
	..()

/mob/living/simple_mob/hostile/metroid/combat/omega //active noms
	vore_active = 1
	vore_bump_chance = 0
	vore_capacity = 2
	vore_icons = SA_ICON_LIVING
...
/mob/living/simple_mob/hostile/metroid/combat/queen
	name = "queen metroid"
...
/mob/living/simple_mob/hostile/metroid/combat/queen/New()
	playsound(src, 'sound/metroid/metroidqueen.ogg', 100, 1)
	queen_amount++
	..()

/mob/living/simple_mob/hostile/metroid/combat/queen/death()
	playsound(src, 'sound/metroid/metroidqueendeath.ogg', 100, 1)
	queen_amount--
	..()


/mob/living/simple_mob/hostile/metroid/combat/queen //active noms
	vore_active = 1
	vore_bump_chance = 0
	vore_capacity = 4
	vore_icons = SA_ICON_LIVING
...
/obj/effect/metroid/egg
	...
	icon_state = "egg"
	var/amount_grown = 0
	var/metroid_type = /mob/living/simple_mob/hostile/metroid/evolution/baby
	New()
		pixel_x = rand(3,-3)
		pixel_y = rand(3,-3)
...
/mob/living/simple_mob/hostile/metroid/evolution/Life()
	. = ..()
...
/mob/living/simple_mob/hostile/metroid/proc/expand_troid()
	new next(get_turf(src))
	visible_message("<span class='warning'>\The [src] suddenly evolves!</span>")
	qdel(src)


/mob/living/simple_mob/hostile/metroid/evolution/handle_regular_status_updates()
	if(stat != DEAD)
...
/mob/living/simple_mob/hostile/metroid/evolution/proc/handle_idle()
...
/mob/living/simple_mob/hostile/metroid/evolution/proc/adjust_nutrition(input)
...
/mob/living/simple_mob/hostile/metroid/evolution/PunchTarget() //this segment determines what the mob does depending on its intent.
	if(victim)
...
/mob/living/simple_mob/hostile/metroid/evolution/proc/can_consume(var/mob/living/L) //This checks to see if the mob can latch onto the target and marks it TRUE.
	if(!L || !istype(L))
	...
	if(L.getarmor(null, "bio") >= 75)
		...
		return FALSE
	if(istype(L, /mob/living/simple_mob/hostile/metroid))
		to_chat(src, "I cannot feed on other metroids...")
		return FALSE
	if(!Adjacent(L))
		to_chat(src, "This subject is too far away...")
		return FALSE
	if(istype(L, /mob/living/carbon) && L.getCloneLoss() >= L.getMaxHealth() * 1.5 || istype(L, /mob/living/simple_mob) && L.stat == DEAD)
		to_chat(src, "This subject does not have an edible life energy...")
		return FALSE
	if(L.has_buckled_mobs())
		for(var/A in L.buckled_mobs)
			if(istype(A, /mob/living/simple_mob/hostile/metroid))
				if(A != src)
					to_chat(src, "\The [A] is already feeding on this subject...")
					return FALSE
	return TRUE

/mob/living/simple_mob/hostile/metroid/evolution/proc/start_consuming(var/mob/living/L) //This segment gets the mob to latch onto the target.
	if(!can_consume(L))
		return
	if(!Adjacent(L))
		return
...
/mob/living/simple_mob/hostile/metroid/evolution/proc/stop_consumption()
	if(!victim)
		return
	victim.unbuckle_mob()
...
/mob/living/simple_mob/hostile/metroid/evolution/proc/handle_consumption()
	if(victim && can_consume(victim) && !stat)
		...
		else if(istype(victim, /mob/living/simple_mob))
...
/mob/living/simple_mob/hostile/metroid/evolution/DoPunch(var/mob/living/L) //Metroid melee.
...
/mob/living/simple_mob/hostile/metroid/evolution/attack_hand(mob/living/carbon/human/M as mob)
...
/mob/living/simple_mob/hostile/metroid/evolution/FindTarget() //This makes it so it doesn't go after another target while succing.
	if(victim) // Don't worry about finding another target if we're sucking on someone's head.
		return
	..()


/mob/living/simple_mob/hostile/metroid/evolution/ClosestDistance()
	if(target_mob.stat == DEAD)
		return 1 // Melee (eat) the target if dead, don't shoot it.
	return ..()


/mob/living/simple_mob/hostile/metroid/evolution/handle_resist()
...
/mob/living/simple_mob/hostile/metroid/evolution/baby/Found(mob/living/L)
	if(isliving(L))
		if(SA_attackable(L))
...
/mob/living/simple_mob/hostile/metroid/combat/Life()
	. = ..()
	...
	if(canEvolve == 1 && nutrition >= evo_point && vore_fullness == 0 && next != "/mob/living/simple_mob/hostile/metroid/combat/queen")
		playsound(src, 'sound/metroid/metroidgrow.ogg', 50, 1)
		paralysis = 7998
		sleep(50)
		paralysis = 0
	...
	else if(queen_amount == 0 && prob(5) && canEvolve == 1 && nutrition >= evo_point && vore_fullness == 0 && next == "/mob/living/simple_mob/hostile/metroid/combat/queen")
		playsound(src, 'sound/metroid/metroidgrow.ogg', 50, 1)
		paralysis = 7998
		sleep(50)
		paralysis = 0
...
/mob/living/simple_mob/hostile/metroid/combat/proc/adjust_nutrition(input)
	nutrition = (nutrition + input) //It handles the metroid's nutrition gain from melee.



/mob/living/simple_mob/hostile/metroid/combat/PunchTarget() //this segment determines what the mob does depending on its intent.
	if(!client) // AI controlled.
		a_intent = I_HURT // Otherwise robust them.
	ai_log("PunchTarget() will [a_intent] [target_mob]",2)
	..()
...
/mob/living/simple_mob/hostile/metroid/combat/DoPunch(var/mob/living/L) //Metroid actions vs the player.
	var/damage_to_do = rand(melee_damage_lower, melee_damage_upper)
	var/armor_modifier = abs((L.getarmor(null, "bio") / 100) - 1)
...
/mob/living/simple_mob/hostile/metroid/combat/ClosestDistance()
	if(target_mob.stat == DEAD)
		return 1 // Melee (eat) the target if dead, don't shoot it.
	return ..()
