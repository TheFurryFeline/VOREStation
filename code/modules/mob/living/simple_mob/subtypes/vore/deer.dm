...
/mob/living/simple_mob/deer/New()
	...
	..()
/mob/living/simple_mob/deer/init_vore()
	..()
...
/mob/living/simple_mob/deer/Life()
	. = ..()
	if(!.) return

	handle_flee_target()

/mob/living/simple_mob/deer/proc/handle_flee_target()
...
/mob/living/simple_mob/deer/react_to_attack(var/atom/A)
	if(A == src) return
	flee_target = A
	turns_since_scan = 5

/mob/living/simple_mob/deer/ex_act()
	. = ..()
