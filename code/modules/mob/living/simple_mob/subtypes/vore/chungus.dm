/mob/living/simple_mob/hostile/chungus
	name = "big chungus"
...
/mob/living/simple_mob/hostile/chungus/passive
	name = "big chungus"
...
/mob/living/simple_mob/hostile/chungus/passive/Life()
	. = ..()
	if(!. || ai_inactive)
		return
...
/mob/living/simple_mob/hostile/chungus/passive/attackby(var/obj/item/O, var/mob/user) // Feed the chungus your food to satisfy it.
...
/mob/living/simple_mob/hostile/chungus/passive/Found(var/atom/found_atom)
...
/mob/living/simple_mob/hostile/chungus/passive/FindTarget()
	var/atom/T = null
