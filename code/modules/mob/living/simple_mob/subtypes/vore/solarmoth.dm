/mob/living/simple_mob/retaliate/solarmoth
	name = "solarmoth"
	desc = "A majestic sparkling solarmoth. Also a slight engineering hazard."
	icon = 'icons/mob/vore40x40.dmi'
...
/mob/living/simple_mob/retaliate/solarmoth/PunchTarget()
...
/mob/living/simple_mob/retaliate/solarmoth/Life()
	. = ..()
...
/mob/living/simple_mob/retaliate/solarmoth/proc/explode()
	src.anchored = 0
	set_light(0)
...
/mob/living/simple_mob/retaliate/solarmoth/death()
	explode()
	..()

/mob/living/simple_mob/retaliate/solarmoth/gib() //This baby will explode no matter what you do to it.
	explode()
	..()



/mob/living/simple_mob/retaliate/solarmoth/handle_light()
	. = ..()
	if(. == 0 && !is_dead())
...
/mob/living/simple_mob/retaliate/solarmoth //active noms
	vore_bump_chance = 50
...
/mob/living/simple_mob/retaliate/solarmoth/lunarmoth
	name = "lunarmoth"
...
/mob/living/simple_mob/retaliate/solarmoth/lunarmoth/proc/chilltheglass() //Why does a coldfusion moth do this? science -shark
	nospampls = 1
	if(prob(25))
...
/mob/living/simple_mob/retaliate/solarmoth/lunarmoth/Life()
	..()
	if(!nospampls)
