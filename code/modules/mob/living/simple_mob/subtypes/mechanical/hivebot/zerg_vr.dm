...
/mob/living/simple_mob/hostile/hivebot/zerg //Base Zerg template
	name = "zerg template"
	...
	var/zerg_types = list("Zerg Drone" = /mob/living/simple_mob/hostile/hivebot/zerg/worker,)
...
/mob/living/simple_mob/hostile/hivebot/zerg/larva
	name = "zerg larva"
	...
	New()
		..()
		verbs |= /mob/living/simple_mob/hostile/hivebot/zerg/larva/proc/evolve
...
///////////////////// EVOLUTION /////////////////////////////////
/////////////////////////////////////////////////////////////////
/mob/living/simple_mob/hostile/hivebot/zerg/larva/proc/evolve()
	...
	if(!src.client)
		qdel(src)
		new /mob/living/simple_mob/hostile/hivebot/zerg/worker(location)
	else

		var/myuser = src.key
		var/mob/living/simple_mob/hostile/newmob = chosentype
		death()
		qdel(src)
		newmob.ckey = myuser
		new newmob(location)
...
///////////////////// ZERG TYPES ////////////////////////////////
/////////////////////////////////////////////////////////////////
/mob/living/simple_mob/hostile/hivebot/zerg/worker
	name = "Zerg Drone"
...
/mob/living/simple_mob/hostile/hivebot/zerg/broodsack
	name = "Zerg Brood"
	...
	Life()
		sleep(3000)
		new /mob/living/simple_mob/hostile/hivebot/zerg/larva(src.loc)
		new /mob/living/simple_mob/hostile/hivebot/zerg/larva(src.loc)
		new /mob/living/simple_mob/hostile/hivebot/zerg/larva(src.loc)
